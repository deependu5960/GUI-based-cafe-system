...
class Beverages(QWidget):
    ...
    def Bev_ui(self):
        ...
        for i,menu in enumerate(self.menus,start=1):
            ...
            img = QPixmap(fr"images/beverages/menu{i}.png").scaled(200, 200)
            img_label = QLabel()
        ...
        self.menus_name = ["Expresso","Cappuccino","Latte","Americano","Cold-Coffee","Masala-chai"]
        self.menus_price = [80,120,130,100,150,50]
        ...
        for i, menu in enumerate(self.menus):
            ...
            btn.setProperty("image", fr"images/menu{i+1}.png")
