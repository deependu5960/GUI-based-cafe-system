...
class Snacks(QWidget):
    ...
    def Snac_ui(self):
        ...
        for i,menu in enumerate(self.menus,start=1):
            ...
            img = QPixmap(fr"images\snacks\menu{i}.png").scaled(200, 200)
            img_label = QLabel()
        ...
        self.menus_name = ["Veg Sandwich","Grilled Cheese Sandwich","French Fries","Garlic Bread","Paneer Wrap","Veg Burger"]
        self.menus_price = [120,140,100,130,160,150]
        ...
        for i, menu in enumerate(self.menus):
            ...
            btn.setProperty("image", fr"images\snacks\menu{i+1}.png")
